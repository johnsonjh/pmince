...
int CBop(register unsigned char uc, register struct regs *regp,
         register unsigned char *tpa);
int DDCBop(register unsigned char op, register unsigned char uc,
           register struct regs *regp, register unsigned char *tpa);
int FDCBop(register unsigned char op, register unsigned char uc,
           register struct regs *regp, register unsigned char *tpa);
#else /* Not DNIX */
...
enum STATE { off, idle, esc, waitrow, waitcol };
