/*****************************************************************
 *	Z29keys.C - key bindings for the Z29/H29 keypad.
...
/* "function" keys */
	...
	functs[128+'P'] = MNotImpl;	/* M-P (F6-key) */
	functs[128+'Q'] = MQryRplc;	/* M-Q (F7-key) */
	functs[128+'R'] = MReplace;	/* M-R (F8-key) */

	functs[128+'~'] = MNotImpl;	/* M-~ (HELP key) */
	functs[128+'J'] = MNotImpl;	/* M-J (ERASE key) */
	functs[128+'E'] = MNotImpl;	/* M-E (Shifted ERASE key) */
	functs[128+'H'] = MNotImpl;	/* M-H (HOME key) */

