...
#  ifdef Z80
				if (ii == 0xCB || ii == 0xDD || ii == 0xED || ii == 0xFD) {
					if (ii == 0xCB) {
						ll = 1; cycp = cycletabl1;
					}else if (ii == 0xDD) {
						ll = 2; cycp = cycletabl2;
					}else if (ii == 0xED) {
						ll = 3; cycp = cycletabl3;
					}else if (ii == 0xFD) {
						ll = 4; cycp = cycletabl4;
					}
					for (jj = 0; jj < 256; jj++) {
						ops[0] = records[kk].op0 = ii;
						...
						if ((ii == 0xDD || ii == 0xFD) && jj == 0xCB) {
							if (ii == 0xDD) {
								nn = 5; cycp = cycletabl5;
							}else if (ii == 0xFD) {
								nn = 6; cycp = cycletabl6;
							}
							ops[2] = 0;
